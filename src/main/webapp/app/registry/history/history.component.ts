...
import { SimHistoryService } from './history.service';
...
export class SimHistoryComponent implements OnInit, OnDestroy {
    items: any;
    data: any;
    activeKey: any;
    ...
    constructor(private historyService: SimHistoryService, private refreshService: SimRefreshService) {}
