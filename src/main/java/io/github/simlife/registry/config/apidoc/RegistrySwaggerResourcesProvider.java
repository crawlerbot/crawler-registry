package io.github.simlife.registry.config.apidoc;
...
public class RegistrySwaggerResourcesProvider implements SwaggerResourcesProvider {
    ...
    public List<SwaggerResource> get() {
        ...
        //Add the registry swagger resource that correspond to the simlife-registry's own swagger doc
        resources.add(swaggerResource("simlife-registry", "/v2/api-docs"));
